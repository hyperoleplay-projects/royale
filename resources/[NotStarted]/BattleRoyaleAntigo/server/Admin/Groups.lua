...
function Group.add(userId,group,staffId)
    ...
    if staffSource then
        TriggerClientEvent("Notify",staffSource,"sucess","Usuário <b>"..userId.."</b> adicionado à <b>"..group.."</b>.")
    end
end
-----------------------------------------------------------------------------------------------------------------------------------------
...
function Group.remove(userId,group,staffId)
    ...
    if staffSource then
        TriggerClientEvent("Notify",staffSource,"sucess","Usuário <b>"..userId.."</b> removido de <b>"..group.."</b>.")
    end
end
-----------------------------------------------------------------------------------------------------------------------------------------
