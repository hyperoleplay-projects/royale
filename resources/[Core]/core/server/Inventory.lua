...
function Inventory.LoadInventory(source, user_id)
    ...
    for k, v in pairs(userInventory) do
        ...
        elseif v.inventory_itemType == "tatuagem" then
        ...
        elseif v.inventory_itemType == "barbearia" then
        ...
        elseif v.inventory_itemType == "skin" then
    ...
    PlayerState.userSkins = SkinsData
end
-----------------------------------------------------------------------------------------------------------------------------------------
...
function Inventory.GiveItem(source, user_id, data)
    ...
    if item then
        ...
        TriggerClientEvent("NotifyItem", source, "RECEBEU", itemImage)
    end
    ...
    clientAPI.clearInfoCache(source, 'ROUPAS')
    clientAPI.clearInfoCache(source, 'ROUPAS')
    clientAPI.clearInfoCache(source, 'BARBEARIA')
    clientAPI.clearInfoCache(source, 'TATUAGEM')
