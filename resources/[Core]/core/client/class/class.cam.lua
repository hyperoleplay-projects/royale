cam = {
    ...
    CreateCamLobby = function(name) 
        -- -3290.34,-935.86,613.7,102.05
        local c = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", -3290.34,-935.86,613.7, f(0), f(0), f(102.05), f(38),true,2)
        cam.cams[name] = c 
    end,
    CreateCamLobby1 = function(name) 
        -- -3290.34,-935.86,613.7,102.05
        local c = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", -3258.87,-928.12,614.39, f(0), f(0), f(102.05), f(38),true,2)
        cam.cams[name] = c 
    end,

    CreateCamCheckout = function(name) 
        -- -3290.34,-935.86,613.7,102.05
        local c = CreateCamWithParams("DEFAULT_SCRIPTED_CAMERA", 118.86,-739.47,254.15+0.3, f(0), f(0), f(245.14), f(48),true,2)
        cam.cams[name] = c 
    end,
