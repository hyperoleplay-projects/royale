function WPrompt(){
	...
	this.div_header = document.createElement("header");
	this.div_header.classList.add("wprompt-header");
	this.img_header = document.createElement("img");
	// this.img_header.src = "assets/logo.png";
	this.div_title = document.createElement("div");
	this.div_title.classList.add("wprompt-title")
	this.div_title_content = document.createElement("h1");
	this.div_title.appendChild(this.div_title_content);
	// this.div_header.appendChild(this.img_header);
	...
	this.div_area.spellcheck = false;
	...
	this.div_help.innerHTML = "Aperte o TAB para confirmar";
...
WPrompt.prototype.open = function(title,text){
	this.close();
	this.div_title_content.innerHTML = title;
